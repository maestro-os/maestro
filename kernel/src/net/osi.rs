...
use crate::{net::sockaddr::SaFamily, sync::spin::Spin};
use core::fmt::Debug;
...
static DOMAINS: Spin<HashMap<SaFamily, LayerBuilder>> = Spin::new(HashMap::new());
...
static DEFAULT_PROTOCOLS: Spin<HashMap<(SaFamily, SocketType), u32>> = Spin::new(HashMap::new());
