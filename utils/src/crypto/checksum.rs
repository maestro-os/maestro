...
//! Checksum algorithms, for integrity checks.
...
pub fn crc32_lookuptable(table: &mut [u32; 256], polynomial: u32) {
	// Little endian
...
/// Computes the CRC32 checksum on the given data `data` with the given `table`, built with
/// [`crc32_lookuptable`].
pub fn crc32(data: &[u8], table: &[u32; 256]) -> u32 {
	// Sarwate algorithm
	let mut crc = !0u32;
	for b in data {
